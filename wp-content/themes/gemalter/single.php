                ...
                <div class="article__box container">
                    ...
                    <div class="article__wrapper">
                        <div class="article__inner">
                            <p class="article__datetime" datetime="<?php date(DATE_ATOM, strtotime($post->post_date)); ?>">
                            ...
                            <ul class="article__socials">
                                <li class="article__socials-item article__socials-item--twitter"
                                    aria-label="twitter">
                                    <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php the_url( (get_url_lang_prefix()) . $wp->request . '/'); ?>" class="article__socials-link">
