                        ...
                        <ul>
                          <?php foreach ($menu->children as $itemChild) : ?>
                            <li class="footer-line">
                                <a href="<?php echo ($itemChild->url ? $itemChild->url : '#'); ?>">
  ...
  <div class="modal__window modal-icon-line">
    ...
    <div class="modal__content ">
      ...
      <p class="text--center"><i>
          Leave your phone number or email and we will contact you </i></p>
      <div class="modal-bg">
        ...
        <div class="form ">
          <div class="c-form-country-select form-group--05">
            ...
            </div> <input type="number" name="contact-phone-code" id="contact-phone-code" class="phone-mask" placeholder="+xxx-xxx-xxxx">
          </div>

          <div class="form-group--05">
            <input type="email" name="postal-code" id="contact-email" class="input-animation" placeholder="Email address *">
      ...
      <div class="modal-action">
        <div class="btn btn--accent-border">Send</div>
      </div>
    </div>
