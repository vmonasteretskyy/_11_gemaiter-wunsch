...
<li>
    <div class="c-payment__acc">
        <label class="radio-button " for="payment_method_<?php echo esc_attr($gateway->id); ?>">
            <input id="payment_method_<?php echo esc_attr($gateway->id); ?>" type="radio" name="payment_method"
                   ...
                   data-order_button_text="<?php echo pll__(esc_attr($gateway->order_button_text)); ?>">
            ...
            <div class="stripe_extra_fields" <?php if (!$gateway->chosen): ?> style="display: none;" <?php endif; ?>>
                <div class="credit-card form">
                    <div class="credit-card__picture">
                        <svg width="415" height="257" viewBox="0 0 415 257" fill="none"
                            ...
                            <g class="svg-cvv">
                                ...
                                <rect x="262.5" y="95.5" width="82" height="51" rx="5.5" fill="#F9AB97"
                                      fill-opacity="0.2" stroke="#F9AB97"/>
                            </g>
                            <g class="svg-card-front">
                                <path d="M10 256.5C222.185 231.6 310.504 179.17 411.26 22.8424C412.344 21.1604 415 21.8693 415 23.8703V237.68C415 237.892 414.966 238.106 414.899 238.308C411.192 249.452 407.163 253.822 395.757 256.907C395.589 256.952 395.412 256.976 395.237 256.976L10 256.5Z"
                                      fill="#FCFCFC"/>
                                <rect x="0.5" y="0.5" width="414" height="256" rx="19.5" stroke="#CDCFD6"/>
                    ...
                    <div class="credit-card__row">
                        ...
                        <div class="payment_box payment_method_<?php echo esc_attr($gateway->id); ?>"
                            ...
                            <div class="payment_box payment_method_<?php echo esc_attr($gateway->id); ?>"
                                 <?php if (!$gateway->chosen) : ?>style="display:none;"<?php endif; ?>>
                                <fieldset id="wc-<?php echo esc_attr($gateway->id); ?>-cc-form"
                                    ...
                                    <?php if ($gateway->inline_cc_form) { ?>
                                        ...
                                        <div id="stripe-card-element" class="wc-stripe-elements-field"
                                             data-target='svg-number'>
                                            <!-- a Stripe Element will be inserted here. -->
                                        </div>
                                    <?php } else { ?>
                                        <div class="form-row form-row-wide">
                                            <label for="stripe-card-element"><?php pll_e('Card Number'); ?> <span
                                                        class="required">*</span></label>
                                            <div class="stripe-card-group">
                                                <div id="stripe-card-element"
                                                     class="credit-card__number wc-stripe-elements-field"
                                                     data-target='svg-number'>
                                                    <!-- a Stripe Element will be inserted here. -->
                                                </div>
                                        ...
                                        <div class="form-row form-row-wide2">
                                            <div class="form-row form-row-first">
                                                <label for="stripe-exp-element"><?php pll_e('Expiry Date'); ?> <span
                                                            class="required">*</span></label>

                                                <div id="stripe-exp-element" class="wc-stripe-elements-field"
                                                     data-target='svg-date'>
                                                    <!-- a Stripe Element will be inserted here. -->
                                                </div>
                                            </div>

                                            <div class="form-row form-row-last">
                                                <label for="stripe-cvc-element"><?php pll_e('Card Code (CVC)'); ?> <span
                                                            class="required">*</span></label>
    ...
    <?php if ($gID == 'klarna_payments_pay_later'): ?>
        <?php if ($gateway->has_fields() || $gateway->get_description()) : ?>
            <div <?php if (!$gateway->chosen): ?><?php endif; ?>
