        ...
        <header class="header" style="top: auto">
            <div class="header-top">
                <div class="header-top__left">
                    <p><span>Handmade Portraits with</span> 100% Money Back Guarentee + Free Shipping</p>
                </div>
                <div class="header-top__center">
                    <p> Need Help? Contact Us!
                        <a href="tel:+4917695860781">+49 176 9586 0781</a>
                        Email:
                        <a href="mailto:support@painteddesire.com">support@painteddesire.com</a>
                    </p>
                    <ul>
                        <li>
                ...
                <div class="header-top__right">
                    ...
                    <div class="header__langs_wrap">
                        <a href="#" class="header__langs_a active">EN</a>
                        <a href="#" class="header__langs_a">DE</a>
                    </div>
                </div>
            </div>
            <div class="header__row">
                ...
                <div class="burger hidden-on-desktop">
                    ...
                    <span>&nbsp;</span>
                    <span>&nbsp;</span>
                    <div class="burger__label">close</div>
                </div>
                    ...
                    <nav class="nav">
                        <div class="nav-wrap">
                            ...
                            <ul class="nav__menu">
                                ...
                                <li >
                                    <a href="pricing.html">Pricing & Duration</a>
                                </li>
                                <li >
                                    <a href="procedure.html">Process</a>
                                </li>
                                <li >
                                ...
                                <li>
                                    <a href="#" class="btn btn--accent header-btn">Paint my Desire
                                        <svg>
