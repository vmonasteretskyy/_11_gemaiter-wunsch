...
global $wp;
$data = [];
$data['page_post'] = get_post(get_option('page_for_posts', true));
...
?>
    ...
    <div class="page-wrapper page-blog">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs__item">
                <p class="breadcrumbs__link breadcrumbs__link--active"><?php echo isset($data['page_post']->post_title) && $data['page_post']->post_title ? $data['page_post']->post_title : pll__('Blog'); ?></p>
            </li>
        </ul>
        <!-- End breadcrumbs -->
        <?php if ((isset($data['page_post']->post_title) && !empty($data['page_post']->post_title)) || isset($data['page_post']->post_content) && !empty($data['page_post']->post_content)): ?>
            <div class="container-small mx-w-1050">
                <?php if ((isset($data['page_post']->post_title) && !empty($data['page_post']->post_title))): ?>
                    <div class="title-wrap m-b-90">
                        <h2 class="">
                            <?php echo $data['page_post']->post_title;?>
                        </h2>
                    </div>
                <?php endif; ?>
                <?php if (isset($data['page_post']->post_content) && !empty($data['page_post']->post_content)): ?>
                    <div class="text text--center text--lite-color m-b-80 text--span-f-w-600">
                        <?php echo wpautop($data['page_post']->post_content);?>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        <div class="container-small m-t-80 m-b-90">
            <ul class="blog-filter">
                <?php if (!empty($data['categories'])): ?>
                    ...
                    <?php endforeach; ?>
                <?php endif; ?>
                <li class="blog-filter__item active">
